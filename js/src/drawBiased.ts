...
const canvas = document.getElementById("draw-biased") as HTMLCanvasElement;
const ctx = canvas.getContext("2d", { willReadFrequently: true })!;

const dragCanvas = document.getElementById("drag-biased") as HTMLCanvasElement;
const dragCtx = dragCanvas.getContext("2d", { willReadFrequently: true })!;

const output = document.getElementById("output-biased")!;
const probsContainer = document.getElementById("probabilities-biased")!;
...
async function getSession() {
  ...
  const modelUrl = new URL("./assets/mnist_biased_mlp.onnx", import.meta.url).href;
